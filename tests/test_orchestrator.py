...
class TestJobOrchestrator:
    ...
    def test_init_with_custom_jobs_table(self):
        ...
        orchestrator = JobOrchestrator(
            control_table="test_table",
            jobs_table="custom_jobs_table"
        )
    ...
    def test_create_or_update_job_create_new(self, mock_convert, mock_get_settings, mock_store, mock_get_job_id, mock_generate_tasks, mock_serialize, mock_workspace_client):
        """Test creating a new job."""
        mock_get_job_id.return_value = None  # No existing job
        mock_get_settings.return_value = {"timeout_seconds": 7200, "max_concurrent_runs": 1, "queue": None, "continuous": None, "trigger": None, "schedule": None}
    ...
    @patch('lakeflow_jobs_meta.orchestrator.JobOrchestrator.get_job_settings_for_job')
    @patch('lakeflow_jobs_meta.orchestrator.convert_task_config_to_sdk_task')
    def test_create_or_update_job_update_existing(self, mock_convert, mock_get_settings, mock_get_job_id, mock_generate_tasks, mock_serialize, mock_workspace_client):
    ...
    @patch('lakeflow_jobs_meta.orchestrator.JobOrchestrator.get_job_settings_for_job')
    @patch('lakeflow_jobs_meta.orchestrator.convert_task_config_to_sdk_task')
    def test_create_or_update_job_with_inline_sql_query(self, mock_convert, mock_get_settings, mock_store, mock_get_job_id, mock_generate_tasks, mock_serialize, mock_workspace_client):
    ...
    @patch('lakeflow_jobs_meta.orchestrator._get_spark')
    def test_create_or_update_jobs_success(self, mock_get_spark, mock_ensure_setup, mock_metadata_manager, mock_spark_session, mock_workspace_client):
        ...
        jobs = orchestrator.create_or_update_jobs(auto_run=False)
    ...
    @patch('lakeflow_jobs_meta.orchestrator.JobOrchestrator.ensure_setup')
    @patch('lakeflow_jobs_meta.orchestrator._get_spark')
    def test_create_or_update_jobs_no_jobs(self, mock_get_spark, mock_ensure_setup, mock_metadata_manager, mock_spark_session, mock_workspace_client):
    ...
    @patch('lakeflow_jobs_meta.orchestrator.JobOrchestrator.ensure_setup')
    @patch('lakeflow_jobs_meta.orchestrator._get_spark')
    def test_create_or_update_jobs_partial_failure(self, mock_get_spark, mock_ensure_setup, mock_metadata_manager, mock_spark_session, mock_workspace_client):
    ...
    @patch('lakeflow_jobs_meta.orchestrator.JobOrchestrator.ensure_setup')
    @patch('lakeflow_jobs_meta.orchestrator._get_spark')
    def test_create_or_update_jobs_with_yaml(self, mock_get_spark, mock_ensure_setup, mock_metadata_manager, mock_spark_session, mock_workspace_client):
        """Test orchestration with YAML file loading."""
        mock_get_spark.return_value = mock_spark_session
        
        mock_manager = MagicMock()
        mock_manager.get_all_jobs.return_value = ['job1']
        mock_manager.load_yaml.return_value = 5  # 5 tasks loaded
        mock_metadata_manager.return_value = mock_manager
